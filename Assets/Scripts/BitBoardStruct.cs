...
public struct BitBoardStruct {

	public ulong board;

	public BitBoardStruct(ulong _board) {
		board = _board;
	}
...
/*
	/// <summary>
	/// Sets whether or not a piece is located at given index
	/// </summary>
	public void SetSquare(int index, int value) {
		board ^= (-value ^ board) & (1UL << index);
	}
	*/
	...
	public void Combine(params BitBoardStruct[] bitBoards) {
	...
	/// </summary>
	public static BitBoardStruct Combination(params BitBoardStruct[] bitBoards) {
		...
		return new BitBoardStruct(combinedBoard);
	}
